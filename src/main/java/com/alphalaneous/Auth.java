...
public class Auth {
    ...
    public static Credential authorize(List<String> scopes, String credentialDatastore, boolean refresh) throws IOException {
        ...
        File correctDirectory = new File("/loquibot/");
        ...
        if(refresh) {
            Path originalPath = Paths.get("/loquibot/" + credentialDatastore);
            Path tempPath = Paths.get("/loquibot/" + credentialDatastore + "_temp");
